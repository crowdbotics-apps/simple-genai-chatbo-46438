"""
Django settings for simple_genai_chatbo_46438 project.
...
ROOT_URLCONF = 'simple_genai_chatbo_46438.urls'
...
WSGI_APPLICATION = 'simple_genai_chatbo_46438.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "simple_genai_chatbo_46438 API",
    "DESCRIPTION": "API documentation for simple_genai_chatbo_46438 App",
    "VERSION": "v1",
}
